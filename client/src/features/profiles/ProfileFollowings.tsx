  ...
  return (
    <Box>
        ...
        {loadingFollowings 
            ...
            : followings === undefined || followings.length < 1
                ? <Typography>{activeTab === 3 ? `${profile?.displayName} has now followers` : `${profile?.displayName} is not following anyone`}</Typography>
                :  (
